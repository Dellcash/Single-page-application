  ...
  <div class="body">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top shadow">
      <div class="container-fluid">
        ...
        <!-- offcanvas trigger -->
        <router-link class="navbar-brand m-0 me-lg-3" to="/">
          <img
            src="@/assets/images/eye-tracking.png"
            style="width:50px;"
            alt=""
          />
        </router-link>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <form class="d-flex me-auto">
            <div class="input-group flex-row-reverse mt-4 mt-lg-0">
          ...
          <ul class="navbar-nav mb-2 mb-lg-0 text-center p-0 pe-lg-5">
    ...
    <!-- offcanvas -->
    <div
      class="offcanvas offcanvas-end bg-dark text-white sidebar-nav shadow"
      tabindex="-1"
      id="offcanvasExample"
      aria-labelledby="offcanvasExampleLabel"
    >
      <div class="offcanvas-body p-0">
        <nav class="navbar-dark mt-2">
          <ul class="navbar-nav px-0">
            ...
            <li class="px-3">
              <div class="text-muted fw-bold mb-3">رابط کاربری</div>
            </li>
            <li>
              <a
                  ...
                  <ul class="navbar-nav pe-3">
                    <li>
                      <a href="#" class="nav-link px-3">
                        ...
                        <span class="text-dark">داشبورد</span>
                      </a>
                    </li>
                  </ul>
                </div>
            ...
            <li class="px-3 mb-3">
              <div class="text-muted fw-bold">افزونه‌ها</div>
            </li>
            <li class="px-3">
              <a href="#" class="nav-link">
                <span class="ms-2 ">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="card">
              ...
              <div class="card-body">
                <canvas class="charty" width="400" height="200"></canvas>
              </div>
            </div>
          </div>
        </div>
        <div class="row mt-3">
          <div class="col-md-12 mb-3">
            <div class="card">
              <div class="card-header">
                <span><i class="bi bi-table me-2"></i></span> جدول داده‌ها
              </div>
              <div class="card-body">
...
import ChartScript from "@/chart-script.js";
import $ from "jquery";
...
export default {
  ...
  mounted() {
    ...
    const chart = document.querySelectorAll(".charty");
    new Chart(chart, this.ChartScript);
